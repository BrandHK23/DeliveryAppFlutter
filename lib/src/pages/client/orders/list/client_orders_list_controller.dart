...
import 'package:iris_delivery_app_stable/src/pages/client/orders/detail/client_orders_detail_page.dart';
...
class ClientOrdersListController {
  ...
  Future<List<Order>> getOrders(String status) async {
    ...
    return await _ordersProviders.getByClientAndStatus(user.id, status);
  }
